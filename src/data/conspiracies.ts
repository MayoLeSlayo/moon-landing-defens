...
export const evidenceResponses: EvidenceResponse[] = [
  ...
  // Telescopes Can't See Landing Sites - Comprehensive Response
  {
    ...
    scientificSources: ['scientific-american-hubble', 'lro-images', 'jodrell-bank', 'soviet-tracking'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Telescopes Can't See Landing Sites - Educational Response
  {
    ...
    scientificSources: ['scientific-american-hubble', 'lro-images', 'jodrell-bank', 'soviet-tracking', 'royal-museums-greenwich'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // No Liftoff Plume - Short Response
  {
    ...
    scientificSources: ['lunar-samples', 'soviet-tracking', 'royal-museums-greenwich'],
    effectiveness: 8,
    lastUpdated: new Date('2024-01-01')
  },
  // No Liftoff Plume - Comprehensive Response
  {
    ...
    scientificSources: ['lunar-samples', 'apache-point', 'jodrell-bank', 'smithsonian-verification'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // No Liftoff Plume - Educational Response
  {
    ...
    scientificSources: ['lunar-samples', 'apache-point', 'jodrell-bank', 'soviet-tracking', 'smithsonian-verification'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Earth Size Wrong - Short Response
  {
    ...
    scientificSources: ['lro-images', 'royal-museums-greenwich', 'scientific-american-hubble'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Earth Size Wrong - Comprehensive Response
  {
    ...
    scientificSources: ['lro-images', 'jodrell-bank', 'soviet-tracking', 'royal-museums-greenwich'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Earth Size Wrong - Educational Response
  {
    ...
    scientificSources: ['lro-images', 'jodrell-bank', 'soviet-tracking', 'royal-museums-greenwich', 'smithsonian-verification'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Rocket Transformation - Short Response
  {
    ...
    scientificSources: ['jodrell-bank', 'soviet-tracking', 'royal-museums-greenwich'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Rocket Transformation - Comprehensive Response
  {
    ...
    scientificSources: ['jodrell-bank', 'soviet-tracking', 'smithsonian-verification', 'royal-museums-greenwich'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Rocket Transformation - Educational Response
  {
    ...
    scientificSources: ['jodrell-bank', 'soviet-tracking', 'smithsonian-verification', 'royal-museums-greenwich', 'lunar-samples'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Missing Original Tapes - Short Response
  {
    ...
    scientificSources: ['soviet-tracking', 'jodrell-bank', 'royal-museums-greenwich'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Missing Original Tapes - Comprehensive Response
  {
    ...
    scientificSources: ['soviet-tracking', 'jodrell-bank', 'smithsonian-verification', 'royal-museums-greenwich'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Missing Original Tapes - Educational Response
  {
    ...
    scientificSources: ['soviet-tracking', 'jodrell-bank', 'smithsonian-verification', 'royal-museums-greenwich', 'lunar-samples'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Apollo 1 Assassination - Short Response
  {
    ...
    scientificSources: ['royal-museums-greenwich', 'smithsonian-verification', 'soviet-tracking'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Apollo 1 Assassination - Comprehensive Response
  {
    ...
    scientificSources: ['royal-museums-greenwich', 'smithsonian-verification', 'soviet-tracking', 'jodrell-bank'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Apollo 1 Assassination - Educational Response
  {
    ...
    scientificSources: ['royal-museums-greenwich', 'smithsonian-verification', 'soviet-tracking', 'jodrell-bank', 'lunar-samples'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Bill Kaysing Insider - Short Response
  {
    ...
    scientificSources: ['clavius-kaysing', 'smithsonian-verification', 'royal-museums-greenwich'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Bill Kaysing Insider - Comprehensive Response
  {
    ...
    scientificSources: ['clavius-kaysing', 'smithsonian-verification', 'royal-museums-greenwich', 'jodrell-bank'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Bill Kaysing Insider - Educational Response
  {
    ...
    scientificSources: ['clavius-kaysing', 'smithsonian-verification', 'royal-museums-greenwich', 'jodrell-bank', 'lunar-samples'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Area 51 Studio - Short Response
  {
    ...
    scientificSources: ['lro-images', 'royal-museums-greenwich', 'soviet-tracking'],
    effectiveness: 9,
    lastUpdated: new Date('2024-01-01')
  },
  // Area 51 Studio - Comprehensive Response  
  {
    ...
    scientificSources: ['lro-images', 'royal-museums-greenwich', 'soviet-tracking', 'jodrell-bank'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  },
  // Area 51 Studio - Educational Response
  {
    ...
    scientificSources: ['lro-images', 'royal-museums-greenwich', 'soviet-tracking', 'jodrell-bank', 'smithsonian-verification'],
    effectiveness: 10,
    lastUpdated: new Date('2024-01-01')
  }
];
