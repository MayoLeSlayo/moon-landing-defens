            ...
            <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                ...
                <blockquote className="bg-blue-50 border-l-4 border-blue-500 pl-4 py-2 italic text-blue-800 mb-4">
                  "Am I trying to persuade this person, or am I trying to inform the audience watching?"
                </blockquote>
              ...
              <div className="border-l-4 border-red-500 pl-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2 mb-4">
                  <p className="text-gray-600">"What source are you using for that?"</p>
                  <p className="text-gray-600">"What would change your mind?"</p>
                  <p className="text-gray-600">"Have you seen the counterargument that…"</p>
                </div>
              ...
              <div className="border-l-4 border-indigo-500 pl-6">
                ...
                <blockquote className="bg-indigo-50 border-l-4 border-indigo-500 pl-4 py-2 italic text-indigo-800 mb-4">
                  "If I understand you correctly, you're saying that NASA couldn't have hidden a hoax that big without someone leaking it, right?"
                </blockquote>
              ...
              <div className="border-l-4 border-pink-500 pl-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="bg-red-50 p-4 rounded-lg">
                    <p className="text-red-800 font-semibold">❌ "That's a strawman, idiot."</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <p className="text-green-800 font-semibold">✅ "I think there's been a mix-up — I didn't say that. Let me clarify…"</p>
                  </div>
                </div>
              ...
              <div className="border-l-4 border-gray-500 pl-6">
                ...
                <p className="text-gray-700 mb-4">Winning a debate isn't always about "getting the last word." Sometimes, it's knowing when to stop.</p>
                <p className="text-gray-700 mb-4">Ending with class might look like:</p>
                <div className="bg-gray-50 p-4 rounded-lg space-y-2 mb-4">
                  <p className="text-gray-600">"Appreciate the discussion — I think we'll have to agree to disagree for now."</p>
                  <p className="text-gray-600">"Thanks for sharing your thoughts. I'm stepping away from the thread but leaving these links in case others are curious."</p>
                </div>
              ...
              <div className="bg-blue-50 p-8 rounded-xl border-l-4 border-blue-500">
                ...
                <p className="text-gray-700">Whether you're discussing the moon landings or any other hot topic, remember: the goal isn't to "own" someone. The goal is to <em>engage in a way that encourages learning and understanding</em> — even if that takes time.</p>
              </div>
